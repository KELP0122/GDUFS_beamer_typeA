...
\author{ 唐小虎 \textrm{20190000000}}
\title{广东外语外贸大学}
\subtitle{毕业论文答辩}
\institute{广东外语外贸大学电子信息系}
\date{\textrm{2023}年\textrm{4}月\textrm{19}日}
\usepackage{Gdufs_Beamer}
...
\begin{frame}
    ...
    \begin{figure}[htpb]
        \begin{center}
            \includegraphics[width=0.2\linewidth]{pic/gdufs_logo.jpg}
        \end{center}
    \end{figure}
\end{frame}
...
\begin{frame}{用Beamer很高大上？}
    \begin{itemize}[<+-| alert@+>] % 当然，除了alert，手动在里面插 \pause 也行
        ...
        \item 原 THU Beamer Github项目地址位于 
